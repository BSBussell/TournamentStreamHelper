...
LoadEverything().then(() => {
    ...
    let startingAnimation = gsap
        ...
        .from([".p1.container"], { duration: 1.0, y: "-100px", ease: "out" }, 0)
        .from([".p2.container"], { duration: 1.0, y: "-100px", ease: "out" }, 0);
        ...
        if (!isTeams) {
          ...
          `,
            ...
            if (history) {
                ...
                // ------- FUN FACTS -------------
                let facts_html = `<div class ="info title">Fact!</div>`;
                fetch("../DATA/facts.json")
                    ...
                    .then((facts) => {
                        ...
                        tl.from(
                            $(`.info.title`),
                            { scale: 0.0, duration: 0.6, ease: "elastic.out(1, 0.5)" },
